...
namespace SacramentPlanner.Controllers
{
    public class TalksController : Controller
    {
        ...
        public TalksController(SacramentPlannerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Speaker,Subject")] Talk talk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Speaker,Subject")] Talk talk)
        {
            if (id != talk.Id)
            {
                return NotFound();
